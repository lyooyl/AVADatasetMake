...
train_personID_path = './process_file/train_personID.csv'
train_without_personID_path = './process_file/train_without_personID.csv'
out_path = './process_file/train_temp.csv'
    ...
    for temp_data in train_personID:
        ...
        if int(data[0]) == int(temp_data[0]):
            ...
            if int(data[1]) == int(temp_data[1]):
                if abs(float(data[2]) - float(temp_data[2])) < 0.005 and abs(
                        float(data[3]) - float(temp_data[3])) < 0.005 and abs(
                        float(data[4]) - float(temp_data[4])) < 0.005 and abs(
                        float(data[5]) - float(temp_data[5])) < 0.005:
