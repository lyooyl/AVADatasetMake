...
def plot_curve(log_dict, args):
    ...
    for j, metric in enumerate(metrics):
        ...
        plt.xlabel(label)
        plt.plot(xs, ys, label=legend[j], linewidth=0.5)
        plt.legend()
...
def plot_parser() -> object:
    ...
    parser_plt.add_argument(
        ...
        type=str,
        nargs='+',
        default=['mAP/overall'],  # , ['loss', 'prec@top1','recall@top1'],
    ...
    parser_plt.add_argument(
        '--out', type=str, default='mAP-overall.jpg')
...
def main():
    ...
    # plot_curve(log_dict, args)
    plot_curve(log_dict_val, args)
