...
# avaMin_dense_proposals_path = "./process_file/dense_proposals_train.pkl"

# 传参 ../videoData/choose_frames/
json_path = sys.argv[2]
# json_path = "./process_file/choose_frames_middle/"

f = open(avaMin_dense_proposals_path, 'rb')
info = pickle.load(f, encoding='iso-8859-1')

attributes_dict = {'1': dict(aname='limbs', type=2, options={'0': 'drink(left)', '1': 'drink(right)'},
                             default_option_id="", anchor_id='FILE1_Z0_XY1'),
                   # '2': dict(aname='body', type=2, options={'0': 'stand', '1': 'sit', '2': 'walk'},
                   #           default_option_id="", anchor_id='FILE1_Z0_XY1'),
                   }
# 属性字典，从"1"开始编号。可自定义（1头、2身体、3四肢）
# attributes_dict = {'1': dict(aname='head', type=2, options={'0': 'talk', '1': 'bow'},
#                              default_option_id="", anchor_id='FILE1_Z0_XY1'),
#                    '2': dict(aname='body', type=2, options={'0': 'stand', '1': 'sit', '2': 'walk'},
#                              default_option_id="", anchor_id='FILE1_Z0_XY1'),
#                    '3': dict(aname='limbs', type=2, options={'0': 'hand up', '1': 'catch'},
#                              default_option_id="", anchor_id='FILE1_Z0_XY1')}
    ...
    if dirname == temp_dirname:
        ...
        if files_img_num - 1 != image_id:
            files_dict[str(image_id)] = dict(
                fname=i.split(',')[0] + '_' + (str((image_id + 1) * 30 + 1)).zfill(6) + '.jpg', type=2)
        ...
        files_dict[str(image_id)] = dict(
            fname=i.split(',')[0] + '_' + (str(int(i.split(',')[1]) * 30 + 1)).zfill(6) + '.jpg', type=2)
